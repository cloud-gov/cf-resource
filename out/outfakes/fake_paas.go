...
type FakePAAS struct {
	...
	PushAppStub        func(string, string, string, map[string]interface{}, []string, string, bool, bool, bool) error
...
func (fake *FakePAAS) PushApp(arg1 string, arg2 string, arg3 string, arg4 map[string]interface{}, arg5 []string, arg6 string, arg7 bool, arg8 bool, arg9 bool) error {
	var arg5Copy []string
	if arg5 != nil {
	...
	fake.recordInvocation("PushApp", []interface{}{arg1, arg2, arg3, arg4, arg5Copy, arg6, arg7, arg8, arg9})
...
func (fake *FakePAAS) PushAppCalls(stub func(string, string, string, map[string]interface{}, []string, string, bool, bool, bool) error) {
	fake.pushAppMutex.Lock()
	defer fake.pushAppMutex.Unlock()
	fake.PushAppStub = stub
}

func (fake *FakePAAS) PushAppArgsForCall(i int) (string, string, string, map[string]interface{}, []string, string, bool, bool, bool) {
	fake.pushAppMutex.RLock()
	defer fake.pushAppMutex.RUnlock()
